...
class Processor(object):
    def __init__(self, config):
        ...
        self.ori_onlyslots = sorted(list(set([slot.split("-")[1] for slot in self.slot_meta])))
        self.recovered_onlyslots = [slot_recovery2(slot) for slot in self.ori_onlyslots]
